...
} from "./chunk-OZ7S4CCQ.js";
import "./chunk-FWENSTUV.js";
import "./chunk-3WREQX3D.js";
...
import {
  Box_default
} from "./chunk-GR4XONJ4.js";
import "./chunk-AU7CGJAN.js";
import {
  useThemeProps
} from "./chunk-UXI6QQ6F.js";
import {
  alpha,
  darken,
  decomposeColor,
...
import {
  ...
  init_utils,
  useId_default
} from "./chunk-XIQN4LR4.js";
import "./chunk-VONSISOH.js";
import {
  styled_default
} from "./chunk-JYPF7LTF.js";
import {
  HTMLElementType,
  capitalize,
  composeClasses,
  ...
  useOnMount,
  useTimeout
} from "./chunk-QX743442.js";
import "./chunk-FXGGSHSC.js";
import {
  clsx_default,
  init_clsx
...
var gridColumnsTotalWidthSelector = createSelector(gridVisibleColumnDefinitionsSelector, gridColumnPositionsSelector, (visibleColumns, positions) => {
...
var gridRowsDataRowIdToIdLookupSelector = createSelector(gridRowsStateSelector, (rows) => rows.dataRowIdToIdLookup);
...
var gridAdditionalRowGroupsSelector = createSelector(gridRowsStateSelector, (rows) => rows == null ? void 0 : rows.additionalRowGroups);
...
var selectedGridRowsCountSelector = createSelector(gridRowSelectionStateSelector, (selection) => selection.length);
...
var gridFilteredChildrenCountLookupSelector = createSelector(gridFilterStateSelector, (filterState) => filterState.filteredChildrenCountLookup);
...
var gridHeaderFilteringEnabledSelector = createSelector(
...
var gridColumnGroupsHeaderMaxDepthSelector = createSelector(gridColumnGroupingSelector, (columnGrouping) => (columnGrouping == null ? void 0 : columnGrouping.maxDepth) ?? 0);
...
var gridRowSpanningHiddenCellsSelector = createSelector(gridRowSpanningStateSelector, (rowSpanning) => rowSpanning.hiddenCells);
var gridRowSpanningSpannedCellsSelector = createSelector(gridRowSpanningStateSelector, (rowSpanning) => rowSpanning.spannedCells);
var gridRowSpanningHiddenCellsOriginMapSelector = createSelector(gridRowSpanningStateSelector, (rowSpanning) => rowSpanning.hiddenCellOriginMap);
...
var useGridRowSpanning = (apiRef, props) => {
  ...
  const lastRange = React152.useRef(EMPTY_RANGE);
  const updateRowSpanningState = React152.useCallback(
  ...
  const prevRenderContext = React152.useRef(renderContext);
  const isFirstRender = React152.useRef(true);
  const shouldResetState = React152.useRef(false);
  React152.useEffect(() => {
...
var DataGridRaw = React153.forwardRef(function DataGrid(inProps, ref) {
...
var DataGrid2 = React153.memo(DataGridRaw);
