...
const PainAssessment = ({ onPainLevelSelect, selectedLevel }) => {
  console.log(selectedLevel)
  return (
    <div className='lg:p-4 mt-5'>
      <h1 className='lg:text-2xl font-bold font-main text-pry dark:text-blue-400 text-center mb-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-11 gap-2'>
        {painLevels.map((level) => (
          <div
            className='flex flex-col gap items-center w-full'
            key={level.level}
          >
            <div
              onClick={() => onPainLevelSelect(level.level)}
              key={level.level}
